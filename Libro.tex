...
Kruger\endnote{\raggedright\url{https://it.wikipedia.org/wiki/Effetto\_Dunning-Kruger}} è una distorsione cognitiva, dove tendiamo a sopravvalutare le nostre conoscenze. Sebbene il grafico comunemente associato al fenomeno non provenga dallo studio originale, illustra efficacemente questa percezione distorta: quando ci cimentiamo in una nuova materia la percezione delle nostre conoscenze (linea blu) è molto più alta delle nostre effettive competenze (linea rossa). Sappiamo quanto sappiamo, ma non avendo un quadro completo non sappiamo quanto ancora c'è da sapere per auto valutare la percentuale del totale della nostra comprensione.

Bertrand Russell "Il problema dell'umanità è che gli stupidi sono strasicuri, mentre gli intelligenti sono pieni di dubbi"

Più ci si addentra nello studio e nella conoscenza, più ci si rende conto delle innumerevoli ramificazioni del sapere. La conoscenza diviene pertanto un processo in divenire e mai del tutto esaurito. 

Un fenomeno speculare è la sindrome dell'impostore, che porta l'individuo a credere di non meritare i propri traguardi perché pensa siano dovuti al caso, dalla fortuna o dalla sopravvalutazione degli altri. Paradossalmente però, se fossi un vero impostore, difficilmente sperimenteresti questa sindrome in quanto non metteresti in dubbio le tue capacità. Non stai cercando di truffare qualcuno, ma provando solo a fare un buon lavoro. 
...
Noi europei, spesso viviamo il fallimento con vergogna. Dobbiamo essere sempre
perfetti, informati, produttivi, ma questo è impossibile in un mondo complesso dove l'asticella continua ad alzarsi. Cosa ci sarebbe di male se non sapessimo qualcosa? o se avessimo bisogno di aiuto? Non solo, è molto difficile fare qualcosa di nuovo senza sbagliare. Se non fallisci forse non ti stai ponendo obiettivi ambiziosi (e andrebbe bene anche così).
...
\begin{tikzpicture}
    ...
    \addplot[color=blue, dotted, line width=1pt, mark=*, forget plot] 
    ...
    \addplot[color=blue!50, dotted, line width=1pt, mark=o, forget plot] 
    ...
    \addplot[color=red, dotted, line width=1pt, mark=*, forget plot] 
    ...
    \addplot[color=red!50, dotted, line width=1pt, mark=o, forget plot] 
...
Qui di seguito possiamo vedere qual è l'introito calorico mediamente necessario a mantenere un corpo sarcopenico rispetto a uno allenato.
