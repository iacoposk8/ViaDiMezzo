...
Secondo Epicuro, la felicità (atarassia) consiste nell’assenza di dolore fisico e turbamento mentale, cercata attraverso piaceri moderati e la virtù. Se mangi, dormi, bevi e non stai male in generale allora sei felice. Per altri il contrario della felicità non è il dolore, ma la noia. Pensa a
...
\begin{table}[H]
\centering % Consigliato per centrare la tabella
...
\begin{figure}[H] 
\centering
% \floatsetup{valign=c} % Se ti dà errori, assicurati di avere il pacchetto floatrow, altrimenti commentalo
\begin{subfigure}[b]{0.48\textwidth} 
\begin{tikzpicture}
\begin{axis}[
    width=\textwidth, % <--- AGGIUNTO: Forza il grafico a stare nella colonna
    xmin=2006, xmax=2020,
    ymin=0, ymax=3000000,
    xtick={2006,2008,...,2020},
    ytick={0,500000,1000000,1500000,2000000,2500000,3000000},
    xticklabel={\pgfmathprintnumber[int trunc]{\tick}}, 
    xticklabel style={rotate=45, font=\tiny}, % Font piccolo per evitare sovrapposizioni
