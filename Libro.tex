...
Le calorie diminuiscono con l'età in quanto diventano meno efficienti nel consumo di energia. Inoltre, con l'età si tende a perdere massa muscolare (tessuto metabolicamente molto attivo nel bruciare calorie). Di seguito possiamo vedere come può cambiare il peso in uomini e donne attivi o con sarcopenia (naturale processo biologico che porta alla progressiva perdita muscolare). Notiamo come in persone che allenano la massa muscolare, su valori medi, il peso tende a restare più stabile, mentre chi non si allena ha una perdita di muscoli e un aumento di grasso con l'età.
