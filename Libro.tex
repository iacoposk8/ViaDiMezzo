...
Si potrebbe obiettare che la cronaca ci informa dei rischi reali che potremmo incontrare, ma non è così. Per come sono costruite queste informazioni prendono dei fenomeni quantitativamente e statisticamente rarissimi e li fanno sembrare probabili, come venire uccisi, mentre paradossalmente dovrebbero ripetere molto più spesso quanto sia pericoloso salire su un auto. Per informarci realmente sui pericoli, il modo migliore è controllare le statistiche di una certa zona.
\end{mdframed}
