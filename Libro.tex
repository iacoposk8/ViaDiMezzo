...
Per Giulio Cesare Giacobbe, autore di "Come smettere di farsi le seghe mentali e godersi la vita"\endnote{\raggedright\url{https://www.amazon.it/dp/8862209975}}, ogni pensiero che non da luogo ad un'azione potrebbe essere una sega mentale! Questo non è necessariamente un problema. Se un pensiero non porta all'azione e peggiora il nostro stato mentale, allora è una sega mentale dannosa!
...
Sarebbe come visitare un museo e sentirsi dire: se vi fermate a guardare ogni cosa non vedrete nulla. Non è forse
...
vuoi fare o credi di doverle fare? La linea può essere sottile, a volte possiamo trasformare i devo in
...
Un obiettivo è legato al tempo, una volta raggiunto possiamo eliminarlo dalla nostra lista delle cose da fare e passare ad altro. I nostri valori, invece, sono come una bussola. Gli obiettivi vengono generati dai nostri valori.
...
\begin{mdframed}[linewidth=1pt]
Storia tratta dal libro “Il caffè alla fine del mondo”\endnote{\raggedright\url{https://www.amazon.it/dp/B07QX97V5B}}
...
amasse quello che fa. Per alcuni, il “perché” del proprio lavoro è quello di rendere il mondo un posto migliore. Per
altri è semplicemente la possibilità di pagare le bollette o di prendersi cura della famiglia. Il significato non è per
forza uno “scopo superiore”. La sua presenza è spesso correlata al benessere. 
...
positive, tutte le altre invece sono negative o meglio, le etichettiamo come negative. Tramite queste
...
una spiegazione nel passato, come ci ha insegnato la psicoanalisi. Spesso come accade in molti ambiti, è più
...
portare fuoristrada il discorso. Se non si argomenta la propria posizione potrebbero sorgere due effetti
...
critica ben argomentata, soprattutto se ha un fondo di verità e ci tocca su qualcosa per noi molto importante. A quel
...
mi ha ferito, nel tentativo di combattere uno sbaglio con un altro sbaglio, forse inconsapevolmente, stiamo cercando di far insorgere sensi di colpa non dovuti, invece di premiare l'onestà dell'interlocutore. Questo è solo un esempio estremo, non c'è molta differenza ogni volta
...
riuscire a riconoscerle per non cadere vittime di questi stratagemmi comunicativi. Anche, accorgersi se
...
mia relazione come cambierebbe? Anche, al contrario: Se l'altra persona si rifiutasse di fare
...
affievolisce ricerchiamo quell'entusiasmo iniziale con una nuova relazione. Questo bias di
...
gioco d'azzardo, si dice che ho una dipendenza, se invece dipendo da qualcuno, la nostra società ci ha abituato a chiamare questa dipendenza con i sentimenti più alti, come amore. Resta una dipendenza e come tale ci renderà difficile vivere una vita equilibrata. 
...
termini di tempo richiesto alle madri. Come mai gli esseri umani, rispetto alle altre scimmie, ci mettono così tanto
