...
il suo amico Merleau-Ponty a fargli visita e gli chiese: “Ma non potevi farti accompagnare da una guida?”. Sartre
...
30mila casi di avvistamenti di oggetti non identificati. Ma quelli potenzialmente veri sono tra il 3 e il 5\% dei
casi. Dico potenzialmente perché anche quelli potrebbero essere falsi: nel 1990 in Belgio è stata scattata una foto di
un oggetto triangolare con sfere luminose e giudicata vera dal ministero della Difesa e, 11 anni dopo è stata
...
alle prove, basta decontestualizzare, travisare, mostrare solo una parte, impostare i grafici un certo modo,
...
non proponendo una soluzione, in questo modo queste informazioni solo speculazione. Proprio per questo ho sempre
...
Nel caso specifico dei complotti ho trovato interessante questi libri e queste ricerche:
...
potrebbe essere un modo per non impegnarsi, per altri, la monogamia è la acelta che non riceverà critiche dall'esterno.
...
"Wokeism" (o "wokismo" in italiano) è un termine utilizzato per descrivere la consapevolezza e la sensibilizzazione verso le ingiustizie sociali e politiche, come quelle legate a razzismo, discriminazione e disparità.
Tuttavia, il termine è anche usato in modo critico per definire un'ideologia che, secondo alcuni, è troppo radicale, individualista e che spesso si focalizza sulle differenze piuttosto che sull'unità, risultando un movimento troppo radicale o divisivo. 

Storicamente l'idea alla base della sinistra era quella di farsi promotrice ad un approccio inclusivo e trasversale alle battaglie sociali. L'obiettivo era coinvolgere l'intera società nei dibattiti su questioni cruciali: quando si discuteva di razzismo, non erano solo le persone di colore a essere chiamate a partecipare, ma tutta la comunità. Questo principio di partecipazione allargata si rifletteva anche nelle manifestazioni pubbliche, come nella storica Marcia su Washington del 1963 guidata da Martin Luther King Jr., dove bianchi e neri marciarono fianco a fianco per i diritti civili.

Una frangia più estrema e radicale del movimento "woke", ha adottato un approccio differente, basato sul principio che solo chi vive direttamente una forma di discriminazione abbia la legittimità per parlarne. Secondo questa logica, solo le persone nere possono discutere di razzismo, solo le persone LGBTQ+ possono affrontare temi legati alla loro discriminazione, e solo le donne possono occuparsi di femminismo. Credo invece sia più profiquo avvicinare chi ancora non la pensa allo stesso modo piuttosto che respingerlo, inoltre, un'argomentazione risulta giusta o sbagliata se regge a delle controargomentazioni, indipendentemente dalla persona che muove la critica.
Un critico cinematografico non deve essere per forza un regista.
Comprendo che certi gruppi, emarginati per tanti anni, oggi rivendichino questa esclusività, derivate da esperienze di paternalismo, ma così facendo rischiano di commettere lo stesso errore.

Questo cambiamento di prospettiva ha prodotto, in alcuni contesti, pratiche che appaiono contrastanti rispetto ai valori tradizionali della sinistra. In alcune manifestazioni femministe, ad esempio, si è assistito alla separazione tra uomini e donne, con queste ultime posizionate in testa al corteo e gli uomini in coda. 

Tale approccio rischia di creare divisioni e gerarchie che contraddicono l'ideale inclusivo storicamente associato alla sinistra, introducendo elementi di esclusività che tradizionalmente caratterizzavano l'approccio della destra.

Michela Murgia diceva: "Nascere maschi in un sistema patriarcale e maschilista è un po' come essere figli maschi di un boss mafioso". Questo modello di ragionamento per me risulta problematici perché oltre non propone soluzioni, né sociali né individuali, un maschio non ha possibilità di eventualmente redimersi, anche se stabiliamo che le colpe dei padri ricadono sui figli, concetto insostenibile razionalmente a mio avviso, oltretutto, risulta ancora una volta lontano dagli ideali di sinistra e progressisti a cui si associa, sia ancora legato a morali cristiane come quello del peccato originale. Capisco cosa intende, ci sono alcune persone che non scoraggiando certi comportamenti concorrono a mantere vivo il problema, ma per parlare dell'intera popolazione italiana, significa credere che siano la maggioranza, in questo caso senza numeri ma solo con impressioni, forse si hanno solo pessimi esempi. Guardare il mondo dalla propria piccola finestra e dire "questo è il mondo!".

Questo modello che troviamo spesso nel razzismo in generale, dal omofobia al maschilismo al femminismo misandrico, risulta essere un grosso appiattimento del modo di ragionare, uno svilimento e una umiliazione che nega e annulla tutti i progressi di crescita personali fatti dall'individuo, i libri letti, le difficoltà superate, le scelte, le responsabilità, le volte in cui ci si è messi in gioco ecc... Qualsiasi tentativo di edificare noi stessi non servirà, perché tu sei maschio, o vieni da quel paese, o sei di quell'orientamento sessuale, o sei di quel segno zodiacale ecc… e per qualcuno non ci sarà nulla che tu potrai dire o fare per uscirne. 
Dovremmo essere sempre critici verso le etichette, la Repubblica Popolare Democratica di Corea (Corea del Nord), seppur abbia la parola "democratica" al suo interno, difficilmente potremmo sostenerla. Come leggiamo nel fascismo eterno di Umberto Eco\endnote{\raggedright\url{https://www.amazon.it/dp/8893442418}}, il fascismo può essere sia nero che rosso. 

Quando ci si trova davanti a questi dogmi, in quanto tali sarà difficile ragionare, ma la cosa positiva è che possiamo disattivarli con le stesse armi. Se qualcuno dovesse incolparvi in quanto maschio, dite che non vi identificate in maschio e che vi sentite parte della comunità lgbtq+. O che anche voi siete vittime del patriarcato e che quindi andate difesi e non attaccati. Non voglio svilire questo movimento, penso si sarà capito che sono a favore di tutte le uguaglianze sociali ed è per questo che sono critico verso le derivazioni più estreme e poco inclusive di questa ideologia.

Anche socialmente, come citato all'inizio del libro, è molto difficile trovare ridurre tutto ad una causa. 
Indubbiamente le donne sentono una pressione maggiore rispetto agli uomini circa il loro aspetto fisico, ma le stesse donne criticano l'estetica delle altre donne. Quando si parla di mercificazione del corpo femminile si
indica nei maschi la principale causa di questo problema, ma anche utilizzare il proprio fascino per evitare una multa dopo essere stati fermati dalla polizia, concorre al mantenimento dell'oggettificazione del corpo. O culturalmente non c'è nessun problema per una donna dire: io voglio l'uomo alto, mentre se un uomo dice che vuole una ragazza magra, allora è superficiale. Con questo non voglio intendere che sia più difficile essere maschi che femmine, credo che sia il contrario. Sto usando questi pretesti per indicare il problema negli estremismi di questo movimento, che possiamo poi estendere all'appartenere a qualsiasi gruppo. Ci sta attingere da tutto ma non appartenere a nulla, per essere più liberi di cambiare idea, senza dover informare tutti ogni volta che non siamo più quell'etichetta o che in questa etichetta ci sono queste enne discostamenti.

Anche nei media, le fazioni più estreme di questi movimenti stanno rischiando di allontanare le persone dalla causa dell'integrazione, creando forzature di trama in modo che includessero una minoranza. 
Forse è cambiato qualcosa e non sono più aggiornato, ma ricodo negli anni 90 programmi tv come "La tata", "Willy, il principe di Bel-Air", "I Robinson", "Xena", "8 sotto un tetto", Buffy l'ammazzavampiri" e molti altri. 
Tutti guardavamo questi programmi ed era normale, non si faceva caso alla presenza di minoranze, come qualcosa di esotico, futuristico, all'avanguardia o come qualcosa di negativo o da fermare, erano solo serie tv con delle persone normali, fa strano dirlo, perché suona banale. Inserire in un film una donna, un nero, un gay, un disabile, o qualsiasi altra minoranza, non sono elementi che di per sé renderanno migliore il film. Un film è bello per la recitazione, la regia, la trama ecc… e se questa trama prevede una minoranza, verrà rappresentata. Allo stesso modo è giusto essere critici se forzatamente si dovesse inserire un maschio, bianco, etero e colorargli la faccia di nero come succedeva in passato. 

Celebre è stato il caso letterario che nel 2021 ha visto vincere il Premio Planeta a Carmen Mola, un'autrice conosciuta per romanzi noir con protagoniste femminili forti e temi sociali complessi. Tuttavia, durante la cerimonia, si è scoperto che dietro il nome di Carmen Mola si celavano tre uomini: Jorge Díaz, Agustín Martínez e Antonio Mercero, tutti sceneggiatori spagnoli di successo. L'operazione ha suscitato critiche, poiché molti ritengono che l'identità femminile abbia giocato un ruolo nel successo e nella promozione dei libri, spesso elogiati come "femministi" e inclusi in liste di letture per comprendere la realtà delle donne. Questa rivelazione ha scatenato un dibattito sul marketing editoriale e sull'utilizzo di pseudonimi, sottolineando il paradosso storico in cui molte scrittrici hanno usato nomi maschili per superare i pregiudizi di genere.
...
situazioni, collaborando possono portare avanti il progetto comune della collettività.
...
\noindent \textbf{\large Risparmio} \\
Nel grande come nel piccolo abbiamo fondato la nostra economia sul debito anziché sul credito. 
A volte è necessario, comprare una casa senza un mutuo è praticamente
...
Tracciate tutte le spese o se pagate con il bancomat consulatate la vostra app che avrà suddiviso le spese in vari ambiti e guardate dove spendete di più e come ottimizzare. Alcuni studi dimostrano che i soldi non danno la felicità, a meno che li usiate per avere più tempo. 

Un latro esperimento da fare è il conto annuo di sigarette, alcolici, bar,
caffè alle macchinette ecc… o cambiando impiego, senza lasciare il lavoro attuale. Solo quando si
...
euro\endnote{\raggedright\url{https://www.sicurauto.it/news/attualita-e-curiosita/auto-nuova-gli-italiani-hanno-speso-in-media-21-mila-euro-nel-2019/}}. Possiamo trovare utilitarie a chilometro zero spendendo circa la metà, consentendo di risparmiare 10.000 euro facili che possiamo impiegare per altro. In Italia la vita
media di una macchina è di circa 10 anni. Quindi in una vita potremmo possedere circa cinque o sei macchine, significa
che abbiamo un ambito dove possiamo avere un risparmio potenziale di 60.000 euro. Eliminare il superfluo è il modo più semplice per risparmiare, aperitivo, colazione
al bar ecc… Sono pochi soldi, ma tutti i giorni fanno un grosso volume. 
