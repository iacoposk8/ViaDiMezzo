...
Abbiamo visto solo alcuni dei modi in cui la mente potrebbe distorcere la realtà, quindi come possiamo tentare di contenere questo errore?
Esiste un metodo, che seppur non sia perfetto, è il migliore che abbiamo trovato fin'ora. Il metodo scientifico non stabilisce verità assolute, ma produce modelli sempre più precisi della realtà. Di seguito vorrei trasmettere del perchè è così affidabile e migliore rispetto ad altri metodi, che non avendo gli stessi controlli, non consentono una simile robustezza.
