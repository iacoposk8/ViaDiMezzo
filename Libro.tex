...
\noindent \textbf{\large Illusione della memoria} \\
...
\needspace{4cm}
\vspace{1em} % Aggiunge un po' di spazio prima
\begin{center}
    \includegraphics[width=0.95\textwidth]{images/Libro-img00345.jpg}
    \captionof{figure}{Descrizione della tua immagine} % Richiede \usepackage{capt-of} o \usepackage{caption}
    \label{fig:mia_immagine}
\end{center}
\vspace{1em} % Aggiunge un po' di spazio dopo
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.495\textwidth}
        \centering
        % width=1\linewidth riempie tutta la cella, eliminando bordi bianchi
    ...
    \end{subfigure}% <--- QUESTO % È FONDAMENTALE PER TOGLIERE LO SPAZIO BIANCO
    \hfill
    \begin{subfigure}[t]{0.495\textwidth}
        \centering
    ...
    \vspace{1em} % Spazio verticale tra le righe della griglia
...
Se qualcuno dovesse mangiarsi una pizza all'ananas, non sarebbe infrequente assistere ad un scena di sfottò generale verso quella persona. Anche persone della tavolata che hanno appena conosciuto, potrebbero partecipare alla presa in giro, perché si può fare, perché su questo siamo tutti d'accordo che è legittimo canzonare. Ma perché? che problema da? Di esempi se ne potrebbero fare tanti, ma la domanda è: quante sono le cose che ci agiscono? Se non si fa un ragionamento semplice come: perché è un problema? di quante altre cose re-agiamo senza che ci sia a separare stimolo e azione un nostro filtro, un nostro ragionamento, la nostra persona o quella che vorremmo diventare?
...
possiamo, possiamo ridefinire la nostra idea da: soffro a fare questa cosa nell'attesa di raggiungere questo obiettivo ed essere felice; in: trovo piacere nel viaggio invece che nella destinazione. Ma entrambe le prospettive sono giuste, a volte è necesario fare dei sacrifici e fare cose che non ci piacciono. 
...
Coraggioso non è chi non ha paura, anzi, il contrario. Coraggioso è chi, nonostante la paura, riesce ad agire, altrimenti, forse, sarebbe semplicemente mancanza di paura.
...
che le cose ora stanno così e, da qui, posso capire cosa fare per intervenire. Se invece mi lamento e do la colpa a fattori esterni, difficilmente inizierò a capire come intervenire, se credo che la questione sia completamente dipendente da qualcosa che non sono io. Se ci
...
nel presente? Giudicare? Farsi le seghe mentali? Pensare al passato o al futuro? Essere preoccupati? Fantasticare? No! Ognuna di queste tendenze può avere una sua utilità; l'obiettivo è imparare a far sì che questi meccanismi si avviino il meno possibile in modo inconsapevole, campulsivamente. 
...
Ma allora perché? per essere compatiti? Sembrare interessanti? Indaffarati? E perché necessitano che gli
...
Sarà capitato a tutti, durante una discussione, di rendersi conto che la propria idea fosse sbagliata, ma siccome i toni si sono scaldati, la si difende a spada tratta. Ma perchè? Stiamo difendendo la nostra idea o semplicemente non vogliamo perdere? Magari siamo associati ad un partito politico, le persone sanno che abbiamo certe idee e, si aspettano che le difenderemo, perché noi siamo quella cosa lì. Ma perché in una discussione, dove il suo esito non cambia la nostra vita nella pratica, se l'altro ha un idea diversa a volte il nostro stato emotivo si altera? Perché la prendiamo sul personale? Perché sentiamo il bisogno di avere ragione in un litigio e dimostrare che l'altro aveva torto? 
...
cosa vorreste che le persone dicessero di voi? Se sapessi che ti resta soltanto un anno di vita, che tipo di
persona ti piacerebbe essere e cosa vorresti fare in questo tempo? Se rimanessi intrappolato sotto le macerie di un
edificio e ti rimanessero pochi minuti di vita, chi chiameresti al telefono e cosa diresti? 
Se potessi premere un pulsante che mi darebbe la piena approvazione di tutte le persone, cosa farei della mia vita e, che tipo di persona vorrei essere?
Queste domande possono darci indizi sui nostri valori. 
...
La passione non è fatta per durare, mentre le abitudini si.
...
Luca Mazzucchelli dice che se ti stressa ti interessa. Le feste di compleanno dei figlio lo stressano e non lo rendono particolarmente felice, ma per lui è importante rendere felici i suoi bambini. Non si tratta di sconfiggere lo stress, ma dandogli un significato lo si può affrontare meglio, lo si comprende e lo si accetta. Se si ha ansia di parlare in pubblico, non è consigliabile cercare di superare questo ostacolo soltanto di sforzo, ma trovando un valore, una motivazione per fare ciò che si vorrebbe fare. Se ci neghiamo a noi stessi questi lati possono svilupparsi inconsapevolmente fuori dai nostri desideri.
...
sperato. Quando abbiamo aspettative su qualcosa, soprattutto sulle persone, spesso possono diventare pretese. È spesso
...
Affrontare ogni cosa, come se l'avessimo scelta.
...
Immagina di incamminarsi nel bosco senza pensare di dover tornare indietro questo è un po' lo stato meditativo, vivere ciò che c'è non ciò che vorremmo ci fosse, senza uno scopo.
...
profumi, le sensazioni ecc… Si tratta di dare la vostra piena attenzione a qualsiasi cosa stiate facendo in quel
...
Esiste un disallineamento tra ciò che sarebbe utile per il nostro benessere e ciò che la società ci richiede. Se, per esempio, una persona fa un lavoro umile, rischia di sentirsi giudicato negativamente, quasi fosse un fallimento. Questo tipo di mentalità rende ancora più difficile coltivare la gratitudine.
...
dare le cose per scontato, a farci fare qualcosa in più.
...
Molti temono l'idea di dover interrompere l'allenamento a causa di infortuni o impegni, spaventati dalla prospettiva di perdere mesi di duro lavoro. Spesso però questa paura è in gran parte infondata, grazie al fenomeno della memoria muscolare. La maggior parte della forza e della massa può essere riacquisita in poche settimane o in un paio di mesi di allenamento graduale e ben strutturato, anche per stop di quattro mesi.
...
Quando ad esempio qualcuno discute su dove mangiare la pizza, per qualcuno risulta strano, perchè questo è solo un pretesto per stare in compagnia. Più o meno consapevolmente credo che anche per loro sia questo l'obiettivo, ma contemporaneamente,  si cerca l'affermazione del proprio rango sociale, negoziando gerarchie sottili. Cedendo sulla scelta del ristorante 'Andiamo dove preferisci', si ottiene un vantaggio strategico: si appare più accondiscendenti e maturi, o voloendo, ma sconsigliabile, potremmo a giudicare l'esito della serata da una posizione di forza.

Per uscire da questi meccanismi vanno prima di tutto riconosciuti e poi facendoci caso quanto
...
Perché hai bisogno di prendertela con me? Quali sono i bisogni che stanno dietro a questo gesto? Quali incertezza sta cercando di colmare?
Cosa dice dell'altro questo suo commento?
Questo approccio può aiutare a sentirsi meno offesi perché non riguarda noi, ma l'altro e, quindi riuscire a prendere una giusta distanza.S

A volte se qualcuno ti provoca e, tu "subisci" e basta è possibile che dall'altra parte la persona si sentirà in colpa per averlo fatto o forse si stuferà nel non riuscire di farti arrabbiare. Poi rivolgi anche un pensiero a te, perché ti senti infastidito? Quali bisogni senti violati?
Comunichiamo al nostro interlocutore che ci siamo accorti che ha spostato il discorso su di noi o semplicemente ignoriamolo. 
Non giustificare e non contrattaccare, entrambe le strategie rischiano di dare troppo peso alla questione.
Non cerchiamo però di evitare le persone che ci fanno arrabbiare, perché possiamo evitare lui o lei ma non tutti quelli che sanno toccare quei tasti che ci attivano. Se ci invitano da qualche parte e sappiamo che c'è una persona che ci irrita possiamo dire: "Quello è antipatico, oggi non uscirò, così non lo vedo" o invece "So che il modo di scherzare di quella persona mi irrita e sta sera non ho voglia di farmi irritare". Entrambi possono sembrare un evitamento, ma nel secondo caso è consapevole, attribuendomi la responsabilità di questo stato d'animo, non dando la colpa all'altro. In questo modo diventa solo momentaneo, so che oggi non mi va, ma che la responsabilità di come mi sento è mia e pian piano imparerò a gestirla. Anzi, non reagendo a caldo, probabilmente riuscireamo ad avere una relazione più costruttiva rispetto a quando siamo emotivamente troppo attivati.
...
Questo commento non invalida né il contenuto né l'importanza, anzi, se un argomento è di "moda" ne sancisce, ad un certo livello, almeno un'importanza culturale.
\item É troppo giovane per... \\
Per vedere se una persona è brava o competente spesso basta vedere i risultati che ha in quell'ambito, se possibile con un test. Mediamente i giovani non sono bravi in un certo ambito? Può essere, ma se quella persona dimostra di essere brava, ha dimostrato che questa è solo una tendenza, una generalizzazione, non una regola aurea.
...
possono avere sensazioni corporee molto simili. Allo stesso modo quando ci innamoriamo
potremmo provare angoscia e il malessere nel non conoscere i desideri dell'altra persona nei nostri confronti. 
Così, in quel momento noi potremmo scambiare queste sensazioni e credere che se proviamo angoscia, potrebbe non essere la persona giusta per noi. 
...
\begin{axis}[
    xbar, xmin=0,
    width=12cm, 
    % Riduciamo lo spazio extra ai bordi verticali (da 0.5 a 0.1)
    enlarge y limits=0.1,
    % Opzionale: definisce l'altezza tra una barra e l'altra per evitare che si schiaccino
    y=0.8cm,
    % Opzionale: definisce lo spessore delle barre
    bar width=0.5cm,
    % --------------------
